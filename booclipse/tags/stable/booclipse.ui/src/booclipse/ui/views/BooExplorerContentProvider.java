...
class BooExplorerContentProvider implements IStructuredContentProvider,
	...
	public Object[] getChildren(Object parentElement) {
		...
		IBooAssemblySource source = getAssemblySource(parentElement);
		if (null != source) {
	...
	private IBooAssemblySource getAssemblySource(Object parentElement) {
	...
	private Object[] getAssemblySourceChildren(IBooAssemblySource assemblySource) {
