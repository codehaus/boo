...
class BooExplorerLabelProvider implements ILabelProvider {
	...
	public Image getImage(Object element) {
		...
		if (element instanceof IBooAssemblyReference) {
	...
	public String getText(Object element) {
		...
		if (element instanceof IBooAssemblyReference) {
			return ((IBooAssemblyReference)element).getAssemblyName();
		}
