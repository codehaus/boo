 ...
 */
package booclipse.ui.perspectives;

import org.eclipse.ui.*;

import booclipse.ui.views.BooExplorerView;
import booclipse.ui.views.BooInteractiveInterpreterView;
...
public class BooPerspective implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		layout.addNewWizardShortcut("booclipse.ui.wizards.NewClassWizard");
		layout.addNewWizardShortcut("booclipse.ui.wizards.NewAssemblySourceWizard");
		layout.addNewWizardShortcut("booclipse.ui.wizards.NewBooProjectWizard");
