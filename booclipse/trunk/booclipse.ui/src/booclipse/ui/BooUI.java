...
import booclipse.ui.internal.PreferencesAdapter;

public class BooUI extends AbstractUIPlugin {
		
	public static final String ID_PLUGIN = "booclipse.ui";
	...
	public static ResourceBundle getResourceBundle() {
		if (null == _resourceBundle) {
			try {
				_resourceBundle = new PropertyResourceBundle(getDefault().openStream(new Path("plugin.properties"), true));
			} catch (IOException e) {
				logException(e);
