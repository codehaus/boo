...
package booclipse.ui.editors.actions;
...
public final class ToggleCommentAction extends TextEditorAction {
	...
	public static final String ID = "booclipse.ui.editors.actions.ToggleCommentAction";
	...
	public ToggleCommentAction(ResourceBundle bundle, String prefix, ITextEditor editor) {
		...
		setId(ToggleCommentAction.ID);
		setActionDefinitionId(ToggleCommentAction.ID);
	}
		...
		if (!fOperationTarget.canDoOperation(operationCode)) {
			if (shell != null)
				MessageDialog.openError(shell,
						...
						"It's not possible to execute this operation at this time.");
			return;
		}
