...
import booclipse.ui.editors.BooEditor;
import booclipse.ui.editors.input.StringInput;

public class ExpandCodeAction extends Action {

	public static final String ID = "booclipse.ui.editors.actions.ExpandCodeAction";
